...
import 'package:efada/screens/main/NotificationsScreen.dart';
import 'package:efada/screens/main/student/DBStudentFees.dart';
import 'package:efada/screens/main/student/DBStudentProfile.dart';
import 'package:efada/screens/main/student/DBStudentRoutine.dart';
import 'package:efada/screens/main/teacher/DBTeacherAcademic.dart';
import 'package:efada/screens/main/teacher/DBTeacherHW.dart';
import 'package:efada/screens/parent/ChildDashboardScreen.dart';
            ...
            : PersistentTabView(
                ...
                items: [
                  PersistentBottomNavBarItem(
                    ...
                    title: "Home".tr,
                    activeColorPrimary: Color(0xFFF7B147).withOpacity(0.9),
                      ...
                      if (controller.isLoading.value) {
                        return Badge(
                          ...
                          child: Icon(
                            Themify.bell,
                            size: 22.sp,
                            color: Color(0xFFF7B147).withOpacity(0.9),
                          ),
                        );
                      }
                      return Badge(
